...
class TestPackets(unittest.TestCase):
    ...
    def test_init_packet_content(self):
        ...
        expected_bytes = bytes([0x0A, 0x00, 0xC8, 0x00, 0x6C, 0x07, 0x00, 0x00, 0x40, 0x0E])
        
        # Test class attribute
        self.assertEqual(ServerPackets.INIT_PACKET, expected_bytes)
        
        # Test convenience constant
    ...
    def test_init_packet_immutable(self):
        ...
        # Verify it's not a mutable type
    ...
    def test_packet_structure_breakdown(self):
        ...
        for index, expected_byte in expected_structure:
            self.assertEqual(packet_bytes[index], expected_byte,
                           f"Byte at index {index} should be 0x{expected_byte:02X}, got 0x{packet_bytes[index]:02X}")
