...
class EnterGameWorldHandler:
    ...
    def __init__(self, character_db: CharacterDatabase):
        ...
        self.character_screen_handler = CharacterScreenHandler(character_db)
        self.enter_game_handler = EnterGameHandler(character_db)
    ...
    def handle_ingame_ack_and_world_entry(
        ...
        world_data_packet = ServerPackets.new_character_world_data(player_index)
        send_packet_success = ServerSocketUtils.send_packet_with_logging(
            client_socket,
            world_data_packet,
            player_index,
            logger,
        ...
        state_manager.transition_state(player_index, ClientState.IN_GAME)
