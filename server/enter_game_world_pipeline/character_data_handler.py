...
from .exceptions import CharacterDataException
...
class CharacterDataHandler:
    ...
    def send_character_select_and_data(
        ...
        Raises:
            CharacterDataException: If sending character data fails
        """
        time.sleep(0.05)
        char_select_packet = ServerPackets.get_character_select_start_data(player_index)
    ...
    def _create_triple_character_data(
        self, player_index: int, user_id: str, logger: ServerLogger
    ) -> bytes:
        """
