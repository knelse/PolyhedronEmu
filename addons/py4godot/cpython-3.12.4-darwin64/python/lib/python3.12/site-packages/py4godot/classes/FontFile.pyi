...
class FontFile(__font__.Font):
  ...
  @property
  def keep_rounding_remainders(self)->bool: pass
  @keep_rounding_remainders.setter
  def keep_rounding_remainders(self,  value:bool)->None: pass
  @property
  ...
  def set_keep_rounding_remainders(self, keep_rounding_remainders:bool)->None: pass

  def get_keep_rounding_remainders(self)->bool: pass
  ...
  def get_size_cache_list(self, cache_index:int)->typedarray::Vector2i: pass
  ...
  def get_kerning_list(self, cache_index:int, size:int)->typedarray::Vector2i: pass
