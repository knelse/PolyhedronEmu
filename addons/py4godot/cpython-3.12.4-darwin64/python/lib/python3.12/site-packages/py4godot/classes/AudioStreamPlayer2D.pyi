...
class AudioStreamPlayer2D(__node2d__.Node2D):
  ...
  @property
  def volume_linear(self)->float: pass
  @volume_linear.setter
  def volume_linear(self,  value:float)->None: pass
  @property
  ...
  def get_stream(self)->__audiostreammp3__.AudioStreamMP3|__audiostreamsynchronized__.AudioStreamSynchronized|__audiostreamwav__.AudioStreamWAV|__audiostreamrandomizer__.AudioStreamRandomizer|__audiostreammicrophone__.AudioStreamMicrophone|__audiostreamgenerator__.AudioStreamGenerator|__audiostreamplaylist__.AudioStreamPlaylist|__audiostream__.AudioStream|__audiostreaminteractive__.AudioStreamInteractive|__audiostreamoggvorbis__.AudioStreamOggVorbis|__audiostreampolyphonic__.AudioStreamPolyphonic: pass

  def set_volume_db(self, volume_db:float)->None: pass

  def get_volume_db(self)->float: pass

  def set_volume_linear(self, volume_linear:float)->None: pass

  def get_volume_linear(self)->float: pass
  ...
  def set_bus(self, bus:__core__.StringName|str)->None: pass
  ...
  def set_playing(self, enable:bool)->None: pass

  def set_max_distance(self, pixels:float)->None: pass

  def get_max_distance(self)->float: pass

  def set_attenuation(self, curve:float)->None: pass
  ...
  def get_stream_playback(self)->__audiostreamplaybacksynchronized__.AudioStreamPlaybackSynchronized|__audiostreamplayback__.AudioStreamPlayback|__audiostreamplaybackoggvorbis__.AudioStreamPlaybackOggVorbis|__audiostreamgeneratorplayback__.AudioStreamGeneratorPlayback|__audiostreamplaybackplaylist__.AudioStreamPlaybackPlaylist|__audiostreamplaybackpolyphonic__.AudioStreamPlaybackPolyphonic|__audiostreamplaybackresampled__.AudioStreamPlaybackResampled|__audiostreamplaybackinteractive__.AudioStreamPlaybackInteractive: pass
