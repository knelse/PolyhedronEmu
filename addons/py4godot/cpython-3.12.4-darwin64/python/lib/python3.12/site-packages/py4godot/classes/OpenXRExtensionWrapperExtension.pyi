...
class OpenXRExtensionWrapperExtension(__object__.Object):
  ...
  def _on_pre_draw_viewport(self, viewport:__core__.RID)->None: pass

  def _on_post_draw_viewport(self, viewport:__core__.RID)->None: pass
  ...
  def _get_viewport_composition_layer_extension_properties(self)->typedarray::Dictionary: pass
