...
class AudioStreamSynchronized(__audiostream__.AudioStream):
  ...
  def set_sync_stream(self, stream_index:int, audio_stream:__audiostream__.AudioStream)->None: pass

  def get_sync_stream(self, stream_index:int)->__audiostreammp3__.AudioStreamMP3|__audiostreamsynchronized__.AudioStreamSynchronized|__audiostreamwav__.AudioStreamWAV|__audiostreamrandomizer__.AudioStreamRandomizer|__audiostreammicrophone__.AudioStreamMicrophone|__audiostreamgenerator__.AudioStreamGenerator|__audiostreamplaylist__.AudioStreamPlaylist|__audiostream__.AudioStream|__audiostreaminteractive__.AudioStreamInteractive|__audiostreamoggvorbis__.AudioStreamOggVorbis|__audiostreampolyphonic__.AudioStreamPolyphonic: pass

  def set_sync_stream_volume(self, stream_index:int, volume_db:float)->None: pass

  def get_sync_stream_volume(self, stream_index:int)->float: pass
