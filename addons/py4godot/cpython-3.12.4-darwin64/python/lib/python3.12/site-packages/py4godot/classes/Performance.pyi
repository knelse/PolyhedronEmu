...
class Performance(__object__.Object):
  ...
  def add_custom_monitor(self, id:__core__.StringName|str, callable:__core__.Callable, arguments:__core__.Array= __core__.Array.new0())->None: pass

  def remove_custom_monitor(self, id:__core__.StringName|str)->None: pass

  def has_custom_monitor(self, id:__core__.StringName|str)->bool: pass

  def get_custom_monitor(self, id:__core__.StringName|str)->object: pass

  def get_monitor_modification_time(self)->int: pass

  def get_custom_monitor_names(self)->typedarray::StringName: pass
