...
class JavaClass(__refcounted__.RefCounted):
  ...
  def get_java_class_name(self)->str: pass

  def get_java_method_list(self)->typedarray::Dictionary: pass

  def get_java_parent_class(self)->__javaclass__.JavaClass: pass
