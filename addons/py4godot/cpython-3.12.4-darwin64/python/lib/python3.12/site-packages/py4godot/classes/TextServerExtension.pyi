...
class TextServerExtension(__textserver__.TextServer):
  ...
  def _get_support_data(self)->__core__.PackedByteArray: pass
  ...
  def _font_set_keep_rounding_remainders(self, font_rid:__core__.RID, keep_rounding_remainders:bool)->None: pass

  def _font_get_keep_rounding_remainders(self, font_rid:__core__.RID)->bool: pass
  ...
  def _font_get_size_cache_list(self, font_rid:__core__.RID)->typedarray::Vector2i: pass
  ...
  def _font_get_kerning_list(self, font_rid:__core__.RID, size:int)->typedarray::Vector2i: pass
  ...
  def _font_get_supported_glyphs(self, font_rid:__core__.RID)->__core__.PackedInt32Array: pass
  ...
  def _shaped_get_span_embedded_object(self, shaped:__core__.RID, index:int)->object: pass
  ...
  def _parse_structured_text(self, parser_type:int , args:__core__.Array, text:str)->typedarray::Vector3i: pass
