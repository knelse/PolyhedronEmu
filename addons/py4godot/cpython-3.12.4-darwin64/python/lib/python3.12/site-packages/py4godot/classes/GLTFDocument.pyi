...
class GLTFDocument(__resource__.Resource):
  ...
  @staticmethod
  def import_object_model_property(state:__gltfstate__.GLTFState, json_pointer:str)->__gltfobjectmodelproperty__.GLTFObjectModelProperty: pass

  @staticmethod
  def export_object_model_property(state:__gltfstate__.GLTFState, node_path:__core__.NodePath|str, godot_node:__node__.Node, gltf_node_index:int)->__gltfobjectmodelproperty__.GLTFObjectModelProperty: pass
  ...
  @staticmethod
  def get_supported_gltf_extensions()->__core__.PackedStringArray: pass
