...
class AStarGrid2D(__refcounted__.RefCounted):
  ...
  def _estimate_cost(self, from_id:__core__.Vector2i, end_id:__core__.Vector2i)->float: pass
  ...
  def get_point_data_in_region(self, region:__core__.Rect2i)->typedarray::Dictionary: pass
  ...
  def get_id_path(self, from_id:__core__.Vector2i, to_id:__core__.Vector2i, allow_partial_path:bool=False)->typedarray::Vector2i: pass
