...
class TextServerManager(__object__.Object):
  ...
  @staticmethod
  def instance()->TextServerManager:pass
  ...
  def get_interface(self, idx:int)->__textserveradvanced__.TextServerAdvanced|__textserverextension__.TextServerExtension|__textserverdummy__.TextServerDummy|__textserver__.TextServer: pass

  def get_interfaces(self)->typedarray::Dictionary: pass

  def find_interface(self, name:str)->__textserveradvanced__.TextServerAdvanced|__textserverextension__.TextServerExtension|__textserverdummy__.TextServerDummy|__textserver__.TextServer: pass

  def set_primary_interface(self, index:__textserver__.TextServer)->None: pass

  def get_primary_interface(self)->__textserveradvanced__.TextServerAdvanced|__textserverextension__.TextServerExtension|__textserverdummy__.TextServerDummy|__textserver__.TextServer: pass
