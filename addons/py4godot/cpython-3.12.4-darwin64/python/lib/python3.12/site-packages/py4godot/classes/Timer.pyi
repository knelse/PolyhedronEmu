...
class Timer(__node__.Node):
  ...
  @property
  def ignore_time_scale(self)->bool: pass
  @ignore_time_scale.setter
  def ignore_time_scale(self,  value:bool)->None: pass
  @property
  ...
  def set_ignore_time_scale(self, ignore:bool)->None: pass

  def is_ignoring_time_scale(self)->bool: pass
