...
class NavigationLink3D(__node3d__.Node3D):
  ...
  @property
  def end_position(self)->__core__.Vector3: pass
  @end_position.setter
  def end_position(self,  value:__core__.Vector3)->None: pass
  @property
  ...
  def set_start_position(self, position:__core__.Vector3)->None: pass

  def get_start_position(self)->__core__.Vector3: pass

  def set_end_position(self, position:__core__.Vector3)->None: pass

  def get_end_position(self)->__core__.Vector3: pass

  def set_global_start_position(self, position:__core__.Vector3)->None: pass

  def get_global_start_position(self)->__core__.Vector3: pass

  def set_global_end_position(self, position:__core__.Vector3)->None: pass

  def get_global_end_position(self)->__core__.Vector3: pass
