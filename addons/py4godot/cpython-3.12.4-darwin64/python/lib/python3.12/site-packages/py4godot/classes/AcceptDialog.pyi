...
class AcceptDialog(__window__.Window):
  ...
  def get_ok_button(self)->__checkbutton__.CheckButton|__optionbutton__.OptionButton|__checkbox__.CheckBox|__menubutton__.MenuButton|__button__.Button|__colorpickerbutton__.ColorPickerButton: pass
  ...
  def add_button(self, text:str, right:bool=False, action:str= __core__.String.new0())->__checkbutton__.CheckButton|__optionbutton__.OptionButton|__checkbox__.CheckBox|__menubutton__.MenuButton|__button__.Button|__colorpickerbutton__.ColorPickerButton: pass

  def add_cancel_button(self, name:str)->__checkbutton__.CheckButton|__optionbutton__.OptionButton|__checkbox__.CheckBox|__menubutton__.MenuButton|__button__.Button|__colorpickerbutton__.ColorPickerButton: pass
