...
class HTTPClient(__refcounted__.RefCounted):
  ...
  @property
  def connection(self)->__streampeerextension__.StreamPeerExtension|__streampeertcp__.StreamPeerTCP|__streampeerbuffer__.StreamPeerBuffer|__streampeer__.StreamPeer|__streampeertls__.StreamPeerTLS|__streampeergzip__.StreamPeerGZIP: pass
  @connection.setter
  ...
  def get_connection(self)->__streampeerextension__.StreamPeerExtension|__streampeertcp__.StreamPeerTCP|__streampeerbuffer__.StreamPeerBuffer|__streampeer__.StreamPeer|__streampeertls__.StreamPeerTLS|__streampeergzip__.StreamPeerGZIP: pass
