...
class AnimationTree(__animationmixer__.AnimationMixer):
  ...
  @property
  def tree_root(self)->__animationnodeblendtree__.AnimationNodeBlendTree|__animationnodestatemachine__.AnimationNodeStateMachine|__animationrootnode__.AnimationRootNode|__animationnodeanimation__.AnimationNodeAnimation|__animationnodeblendspace2d__.AnimationNodeBlendSpace2D|__animationnodeblendspace1d__.AnimationNodeBlendSpace1D: pass
  @tree_root.setter
  ...
  def get_tree_root(self)->__animationnodeblendtree__.AnimationNodeBlendTree|__animationnodestatemachine__.AnimationNodeStateMachine|__animationrootnode__.AnimationRootNode|__animationnodeanimation__.AnimationNodeAnimation|__animationnodeblendspace2d__.AnimationNodeBlendSpace2D|__animationnodeblendspace1d__.AnimationNodeBlendSpace1D: pass

  def set_advance_expression_base_node(self, path:__core__.NodePath|str)->None: pass

  def get_advance_expression_base_node(self)->__core__.NodePath: pass

  def set_animation_player(self, path:__core__.NodePath|str)->None: pass
