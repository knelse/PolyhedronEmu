...
class AnimatedSprite2D(__node2d__.Node2D):
  ...
  def set_animation(self, name:__core__.StringName|str)->None: pass
  ...
  def play(self, name:__core__.StringName|str= __core__.StringName.new0(), custom_speed:float=1.0, from_end:bool=False)->None: pass

  def play_backwards(self, name:__core__.StringName|str= __core__.StringName.new0())->None: pass
