...
class Animation(__resource__.Resource):
  ...
  def track_set_path(self, track_idx:int, path:__core__.NodePath|str)->None: pass

  def find_track(self, path:__core__.NodePath|str, type:int )->int: pass
  ...
  def animation_track_insert_key(self, track_idx:int, time:float, animation:__core__.StringName|str)->int: pass

  def animation_track_set_key_animation(self, track_idx:int, key_idx:int, animation:__core__.StringName|str)->None: pass

  def animation_track_get_key_animation(self, track_idx:int, key_idx:int)->__core__.StringName: pass

  def add_marker(self, name:__core__.StringName|str, time:float)->None: pass

  def remove_marker(self, name:__core__.StringName|str)->None: pass

  def has_marker(self, name:__core__.StringName|str)->bool: pass

  def get_marker_at_time(self, time:float)->__core__.StringName: pass

  def get_next_marker(self, time:float)->__core__.StringName: pass

  def get_prev_marker(self, time:float)->__core__.StringName: pass

  def get_marker_time(self, name:__core__.StringName|str)->float: pass

  def get_marker_names(self)->__core__.PackedStringArray: pass

  def get_marker_color(self, name:__core__.StringName|str)->__core__.Color: pass

  def set_marker_color(self, name:__core__.StringName|str, color:__core__.Color)->None: pass
  ...
  def optimize(self, allowed_velocity_err:float=0.01, allowed_angular_err:float=0.01, precision:int=3)->None: pass
