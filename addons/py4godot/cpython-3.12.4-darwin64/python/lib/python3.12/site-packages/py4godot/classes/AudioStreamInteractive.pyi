...
class AudioStreamInteractive(__audiostream__.AudioStream):
  ...
  def set_clip_name(self, clip_index:int, name:__core__.StringName|str)->None: pass
  ...
  def get_clip_stream(self, clip_index:int)->__audiostreammp3__.AudioStreamMP3|__audiostreamsynchronized__.AudioStreamSynchronized|__audiostreamwav__.AudioStreamWAV|__audiostreamrandomizer__.AudioStreamRandomizer|__audiostreammicrophone__.AudioStreamMicrophone|__audiostreamgenerator__.AudioStreamGenerator|__audiostreamplaylist__.AudioStreamPlaylist|__audiostream__.AudioStream|__audiostreaminteractive__.AudioStreamInteractive|__audiostreamoggvorbis__.AudioStreamOggVorbis|__audiostreampolyphonic__.AudioStreamPolyphonic: pass
