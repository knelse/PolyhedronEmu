...
class GPUParticlesCollisionHeightField3D(__gpuparticlescollision3d__.GPUParticlesCollision3D):
  ...
  @property
  def heightfield_mask(self)->int: pass
  @heightfield_mask.setter
  def heightfield_mask(self,  value:int)->None: pass
  ...
  def set_heightfield_mask(self, heightfield_mask:int)->None: pass

  def get_heightfield_mask(self)->int: pass

  def set_heightfield_mask_value(self, layer_number:int, value:bool)->None: pass

  def get_heightfield_mask_value(self, layer_number:int)->bool: pass
