...
class NodePathTypedArray():
  ...
  @staticmethod
  def new0() -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new1(from_:Array) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new2(base:Array, type:int, class_name:__core__.StringName|str, script:object) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new3(from_:PackedByteArray) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new4(from_:PackedInt32Array) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new5(from_:PackedInt64Array) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new6(from_:PackedFloat32Array) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new7(from_:PackedFloat64Array) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new8(from_:PackedStringArray) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new9(from_:PackedVector2Array) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new10(from_:PackedVector3Array) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new11(from_:PackedColorArray) -> __nodepathtypedarray__.NodePathTypedArray:pass
  @staticmethod
  def new12(from_:PackedVector4Array) -> __nodepathtypedarray__.NodePathTypedArray:pass
