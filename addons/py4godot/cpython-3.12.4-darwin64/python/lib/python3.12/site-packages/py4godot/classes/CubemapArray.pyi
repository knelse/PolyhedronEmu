...
class CubemapArray(__imagetexturelayered__.ImageTextureLayered):

  @staticmethod
  def constructor()->CubemapArray:pass
  ...
  def __iter__(self)->CubemapArray:pass

  @staticmethod
  def cast(other:__object__.Object)->CubemapArray:pass
