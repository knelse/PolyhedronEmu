...
class AudioStreamWAV(__audiostream__.AudioStream):
  ...
  @staticmethod
  def load_from_buffer(stream_data:__core__.PackedByteArray, options:__core__.Dictionary= __core__.Dictionary.new0())->__audiostreamwav__.AudioStreamWAV: pass

  @staticmethod
  def load_from_file(path:str, options:__core__.Dictionary= __core__.Dictionary.new0())->__audiostreamwav__.AudioStreamWAV: pass
