...
class GeometryInstance3D(__visualinstance3d__.VisualInstance3D):
  ...
  def get_material_override(self)->__ormmaterial3d__.ORMMaterial3D|__standardmaterial3d__.StandardMaterial3D|__shadermaterial__.ShaderMaterial|__placeholdermaterial__.PlaceholderMaterial|__material__.Material|__proceduralskymaterial__.ProceduralSkyMaterial|__basematerial3d__.BaseMaterial3D|__canvasitemmaterial__.CanvasItemMaterial|__panoramaskymaterial__.PanoramaSkyMaterial|__physicalskymaterial__.PhysicalSkyMaterial|__fogmaterial__.FogMaterial|__particleprocessmaterial__.ParticleProcessMaterial: pass

  def set_material_overlay(self, material:__material__.Material)->None: pass

  def get_material_overlay(self)->__ormmaterial3d__.ORMMaterial3D|__standardmaterial3d__.StandardMaterial3D|__shadermaterial__.ShaderMaterial|__placeholdermaterial__.PlaceholderMaterial|__material__.Material|__proceduralskymaterial__.ProceduralSkyMaterial|__basematerial3d__.BaseMaterial3D|__canvasitemmaterial__.CanvasItemMaterial|__panoramaskymaterial__.PanoramaSkyMaterial|__physicalskymaterial__.PhysicalSkyMaterial|__fogmaterial__.FogMaterial|__particleprocessmaterial__.ParticleProcessMaterial: pass
