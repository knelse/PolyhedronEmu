...
class ProjectSettings(__object__.Object):
  ...
  @staticmethod
  def instance()->ProjectSettings:pass
  ...
  def get_setting_with_override(self, name:__core__.StringName|str)->object: pass

  def get_global_class_list(self)->typedarray::Dictionary: pass
