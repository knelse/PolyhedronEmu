...
class TileMapLayer(__node2d__.Node2D):
  ...
  @property
  def occlusion_enabled(self)->bool: pass
  @occlusion_enabled.setter
  def occlusion_enabled(self,  value:bool)->None: pass
  @property
  ...
  def _update_cells(self, coords:__core__.Array, forced_cleanup:bool)->None: pass
  ...
  def is_cell_flipped_h(self, coords:__core__.Vector2i)->bool: pass

  def is_cell_flipped_v(self, coords:__core__.Vector2i)->bool: pass

  def is_cell_transposed(self, coords:__core__.Vector2i)->bool: pass

  def get_used_cells(self)->typedarray::Vector2i: pass

  def get_used_cells_by_id(self, source_id:int=-1, atlas_coords:__core__.Vector2i= __core__.Vector2i.new0(), alternative_tile:int=-1)->typedarray::Vector2i: pass
  ...
  def get_surrounding_cells(self, coords:__core__.Vector2i)->typedarray::Vector2i: pass
  ...
  def set_occlusion_enabled(self, enabled:bool)->None: pass

  def is_occlusion_enabled(self)->bool: pass
