...
class TileSet(__resource__.Resource):
  ...
  def get_source(self, source_id:int)->__tilesetatlassource__.TileSetAtlasSource|__tilesetscenescollectionsource__.TileSetScenesCollectionSource|__tilesetsource__.TileSetSource: pass
