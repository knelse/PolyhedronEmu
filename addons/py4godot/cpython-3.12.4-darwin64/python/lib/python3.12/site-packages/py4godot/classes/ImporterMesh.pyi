...
class ImporterMesh(__resource__.Resource):
  ...
  def get_surface_material(self, surface_idx:int)->__ormmaterial3d__.ORMMaterial3D|__standardmaterial3d__.StandardMaterial3D|__shadermaterial__.ShaderMaterial|__placeholdermaterial__.PlaceholderMaterial|__material__.Material|__proceduralskymaterial__.ProceduralSkyMaterial|__basematerial3d__.BaseMaterial3D|__canvasitemmaterial__.CanvasItemMaterial|__panoramaskymaterial__.PanoramaSkyMaterial|__physicalskymaterial__.PhysicalSkyMaterial|__fogmaterial__.FogMaterial|__particleprocessmaterial__.ParticleProcessMaterial: pass
