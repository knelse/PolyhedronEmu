...
class SoftBody3D(__meshinstance3d__.MeshInstance3D):
  ...
  def set_parent_collision_ignore(self, parent_collision_ignore:__core__.NodePath|str)->None: pass
  ...
  def get_collision_exceptions(self)->typedarray::PhysicsBody3D: pass
  ...
  def set_point_pinned(self, point_index:int, pinned:bool, attachment_path:__core__.NodePath|str= __core__.NodePath.new0(), insert_at:int=-1)->None: pass
