...
class ArrayMesh(__mesh__.Mesh):
  ...
  def add_blend_shape(self, name:__core__.StringName|str)->None: pass

  def get_blend_shape_count(self)->int: pass

  def get_blend_shape_name(self, index:int)->__core__.StringName: pass

  def set_blend_shape_name(self, index:int, name:__core__.StringName|str)->None: pass
  ...
  def surface_remove(self, surf_idx:int)->None: pass
