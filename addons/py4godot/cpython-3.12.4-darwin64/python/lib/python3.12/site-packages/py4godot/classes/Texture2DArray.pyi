...
class Texture2DArray(__imagetexturelayered__.ImageTextureLayered):

  @staticmethod
  def constructor()->Texture2DArray:pass
  ...
  def __iter__(self)->Texture2DArray:pass

  @staticmethod
  def cast(other:__object__.Object)->Texture2DArray:pass
