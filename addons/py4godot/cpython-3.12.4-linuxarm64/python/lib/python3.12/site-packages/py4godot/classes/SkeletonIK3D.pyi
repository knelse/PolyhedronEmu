...
class SkeletonIK3D(__skeletonmodifier3d__.SkeletonModifier3D):
  ...
  def set_root_bone(self, root_bone:__core__.StringName|str)->None: pass

  def get_root_bone(self)->__core__.StringName: pass

  def set_tip_bone(self, tip_bone:__core__.StringName|str)->None: pass
  ...
  def set_target_node(self, node:__core__.NodePath|str)->None: pass
