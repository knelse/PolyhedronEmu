...
class Noise(__resource__.Resource):
  ...
  def get_image_3d(self, width:int, height:int, depth:int, invert:bool=False, normalize:bool=True)->typedarray::Image: pass

  def get_seamless_image_3d(self, width:int, height:int, depth:int, invert:bool=False, skirt:float=0.1, normalize:bool=True)->typedarray::Image: pass
