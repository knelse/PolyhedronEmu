...
class EditorFileDialog(__confirmationdialog__.ConfirmationDialog):
  ...
  def get_vbox(self)->__scripteditorbase__.ScriptEditorBase|__vboxcontainer__.VBoxContainer|__filesystemdock__.FileSystemDock|__colorpicker__.ColorPicker: pass
