...
class WebRTCPeerConnection(__refcounted__.RefCounted):
  ...
  @staticmethod
  def set_default_extension(extension_class:__core__.StringName|str)->None: pass

  def initialize(self, configuration:__core__.Dictionary= __core__.Dictionary.new0())->int: pass

  def create_data_channel(self, label:str, options:__core__.Dictionary= __core__.Dictionary.new0())->__webrtcdatachannel__.WebRTCDataChannel|__webrtcdatachannelextension__.WebRTCDataChannelExtension: pass
