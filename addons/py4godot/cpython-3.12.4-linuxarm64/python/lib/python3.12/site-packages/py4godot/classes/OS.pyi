...
class OS(__object__.Object):
  ...
  def read_string_from_stdin(self, buffer_size:int)->str: pass

  def read_buffer_from_stdin(self, buffer_size:int)->__core__.PackedByteArray: pass

  def get_stdin_type(self)->int: pass

  def get_stdout_type(self)->int: pass

  def get_stderr_type(self)->int: pass
  ...
  def execute_with_pipe(self, path:str, arguments:__core__.PackedStringArray, blocking:bool=True)->__core__.Dictionary: pass
  ...
  def get_version_alias(self)->str: pass
  ...
  def get_temp_dir(self)->str: pass
