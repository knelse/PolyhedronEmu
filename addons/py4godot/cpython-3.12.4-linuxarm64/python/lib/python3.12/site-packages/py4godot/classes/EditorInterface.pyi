...
class EditorInterface(__object__.Object):
  ...
  def get_editor_toaster(self)->__editortoaster__.EditorToaster: pass

  def get_editor_undo_redo(self)->__editorundoredomanager__.EditorUndoRedoManager: pass

  def make_mesh_previews(self, meshes:__core__.Array, preview_size:int)->typedarray::Texture2D: pass
  ...
  def popup_node_selector(self, callback:__core__.Callable, valid_types:__core__.Array=Array[StringName]([]), current_value:__node__.Node= __node__.Node.constructor())->None: pass

  def popup_property_selector(self, object:__object__.Object, callback:__core__.Callable, type_filter:__core__.PackedInt32Array= __core__.PackedInt32Array.new0(), current_value:str= __core__.String.new0())->None: pass

  def popup_method_selector(self, object:__object__.Object, callback:__core__.Callable, current_value:str= __core__.String.new0())->None: pass

  def popup_quick_open(self, callback:__core__.Callable, base_types:__core__.Array=Array[StringName]([]))->None: pass

  def popup_create_dialog(self, callback:__core__.Callable, base_type:__core__.StringName|str= __core__.StringName.new0(), current_type:str= __core__.String.new0(), dialog_title:str= __core__.String.new0(), type_blocklist:__core__.Array=Array[StringName]([]))->None: pass
