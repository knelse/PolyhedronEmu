...
class ReflectionProbe(__visualinstance3d__.VisualInstance3D):
  ...
  @property
  def blend_distance(self)->float: pass
  @blend_distance.setter
  def blend_distance(self,  value:float)->None: pass
  @property
  ...
  def set_blend_distance(self, blend_distance:float)->None: pass

  def get_blend_distance(self)->float: pass
