...
class SkeletonModification2DCCDIK(__skeletonmodification2d__.SkeletonModification2D):
  ...
  def set_target_node(self, target_nodepath:__core__.NodePath|str)->None: pass

  def get_target_node(self)->__core__.NodePath: pass

  def set_tip_node(self, tip_nodepath:__core__.NodePath|str)->None: pass
  ...
  def set_ccdik_joint_bone2d_node(self, joint_idx:int, bone2d_nodepath:__core__.NodePath|str)->None: pass
