...
class Light3D(__visualinstance3d__.VisualInstance3D):
  ...
  @property
  def light_projector(self)->Texture2D,-AnimatedTexture,-AtlasTexture,-CameraTexture,-CanvasTexture,-MeshTexture,-Texture2DRD,-ViewportTexture: pass
  ...
  @property
  def shadow_caster_mask(self)->int: pass
  @shadow_caster_mask.setter
  def shadow_caster_mask(self,  value:int)->None: pass
  @property
  ...
  def set_shadow_caster_mask(self, caster_mask:int)->None: pass

  def get_shadow_caster_mask(self)->int: pass
