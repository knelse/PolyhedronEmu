...
class TileSet(__resource__.Resource):
  ...
  def get_source(self, source_id:int)->__tilesetatlassource__.TileSetAtlasSource|__tilesetsource__.TileSetSource|__tilesetscenescollectionsource__.TileSetScenesCollectionSource: pass
