...
class AcceptDialog(__window__.Window):
  ...
  def get_ok_button(self)->__optionbutton__.OptionButton|__checkbutton__.CheckButton|__button__.Button|__checkbox__.CheckBox|__colorpickerbutton__.ColorPickerButton|__menubutton__.MenuButton: pass
  ...
  def add_button(self, text:str, right:bool=False, action:str= __core__.String.new0())->__optionbutton__.OptionButton|__checkbutton__.CheckButton|__button__.Button|__checkbox__.CheckBox|__colorpickerbutton__.ColorPickerButton|__menubutton__.MenuButton: pass

  def add_cancel_button(self, name:str)->__optionbutton__.OptionButton|__checkbutton__.CheckButton|__button__.Button|__checkbox__.CheckBox|__colorpickerbutton__.ColorPickerButton|__menubutton__.MenuButton: pass
