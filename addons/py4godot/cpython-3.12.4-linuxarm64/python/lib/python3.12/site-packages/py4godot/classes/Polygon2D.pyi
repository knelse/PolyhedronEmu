...
class Polygon2D(__node2d__.Node2D):
  ...
  def add_bone(self, path:__core__.NodePath|str, weights:__core__.PackedFloat32Array)->None: pass
  ...
  def set_bone_path(self, index:int, path:__core__.NodePath|str)->None: pass

  def set_bone_weights(self, index:int, weights:__core__.PackedFloat32Array)->None: pass

  def set_skeleton(self, skeleton:__core__.NodePath|str)->None: pass
