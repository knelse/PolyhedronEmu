...
class NavigationServer3D(__object__.Object):
  ...
  @staticmethod
  def instance()->NavigationServer3D:pass
  ...
  def query_path(self, parameters:__navigationpathqueryparameters3d__.NavigationPathQueryParameters3D, result:__navigationpathqueryresult3d__.NavigationPathQueryResult3D, callback:__core__.Callable= __core__.Callable.new0())->None: pass
  ...
  def region_get_closest_point_to_segment(self, region:__core__.RID, start:__core__.Vector3, end:__core__.Vector3, use_collision:bool=False)->__core__.Vector3: pass

  def region_get_closest_point(self, region:__core__.RID, to_point:__core__.Vector3)->__core__.Vector3: pass

  def region_get_closest_point_normal(self, region:__core__.RID, to_point:__core__.Vector3)->__core__.Vector3: pass

  def region_get_random_point(self, region:__core__.RID, navigation_layers:int, uniformly:bool)->__core__.Vector3: pass

  def region_get_bounds(self, region:__core__.RID)->__core__.AABB: pass
