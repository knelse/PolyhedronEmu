...
class Skeleton3D(__node3d__.Node3D):
  ...
  def get_bone_meta(self, bone_idx:int, key:__core__.StringName|str)->object: pass

  def get_bone_meta_list(self, bone_idx:int)->typedarray::StringName: pass

  def has_bone_meta(self, bone_idx:int, key:__core__.StringName|str)->bool: pass

  def set_bone_meta(self, bone_idx:int, key:__core__.StringName|str, value:object)->None: pass
