...
class TreeItem(__object__.Object):
  ...
  def set_auto_translate_mode(self, column:int, mode:int )->None: pass

  def get_auto_translate_mode(self, column:int)->int: pass
  ...
  def set_custom_draw(self, column:int, object:__object__.Object, callback:__core__.StringName|str)->None: pass
  ...
  def get_custom_font(self, column:int)->__fontvariation__.FontVariation|__systemfont__.SystemFont|__fontfile__.FontFile|__font__.Font: pass
  ...
  def clear_buttons(self)->None: pass
  ...
  def get_button(self, column:int, button_index:int)->__portablecompressedtexture2d__.PortableCompressedTexture2D|__canvastexture__.CanvasTexture|__texture2d__.Texture2D|__compressedtexture2d__.CompressedTexture2D|__curvetexture__.CurveTexture|__imagetexture__.ImageTexture|__texture2drd__.Texture2DRD|__animatedtexture__.AnimatedTexture|__viewporttexture__.ViewportTexture|__meshtexture__.MeshTexture|__atlastexture__.AtlasTexture|__cameratexture__.CameraTexture|__curvexyztexture__.CurveXYZTexture|__gradienttexture1d__.GradientTexture1D|__placeholdertexture2d__.PlaceholderTexture2D|__gradienttexture2d__.GradientTexture2D|__noisetexture2d__.NoiseTexture2D|__externaltexture__.ExternalTexture: pass
  ...
  def get_children(self)->typedarray::TreeItem: pass
  ...
  def call_recursive(self, method:__core__.StringName|str)->None: pass
