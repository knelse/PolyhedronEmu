...
class Resource(__refcounted__.RefCounted):
  ...
  def _get_rid(self)->__core__.RID: pass

  def _reset_state(self)->None: pass

  def _set_path_cache(self, path:str)->None: pass
  ...
  def set_path_cache(self, path:str)->None: pass
