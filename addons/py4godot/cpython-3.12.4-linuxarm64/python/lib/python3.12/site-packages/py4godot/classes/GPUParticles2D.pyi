...
class GPUParticles2D(__node2d__.Node2D):
  ...
  @property
  def use_fixed_seed(self)->bool: pass
  @use_fixed_seed.setter
  def use_fixed_seed(self,  value:bool)->None: pass
  @property
  ...
  @property
  def visibility_rect(self)->__core__.Rect2: pass
  @visibility_rect.setter
  def visibility_rect(self,  value:__core__.Rect2)->None: pass
  @property
  ...
  @property
  def trail_sections(self)->int: pass
  @trail_sections.setter
  def trail_sections(self,  value:int)->None: pass
  @property
  def trail_section_subdivisions(self)->int: pass
  @trail_section_subdivisions.setter
  def trail_section_subdivisions(self,  value:int)->None: pass
  @property
  def process_material(self)->ParticleProcessMaterial,ShaderMaterial: pass
  @process_material.setter
  def process_material(self,  value:__particleprocessmaterial__.ParticleProcessMaterial)->None: pass
  ...
  def set_one_shot(self, secs:bool)->None: pass
  ...
  def set_visibility_rect(self, visibility_rect:__core__.Rect2)->None: pass
  ...
  def request_particles_process(self, process_time:float)->None: pass
  ...
  def get_visibility_rect(self)->__core__.Rect2: pass
  ...
  def get_texture(self)->__portablecompressedtexture2d__.PortableCompressedTexture2D|__canvastexture__.CanvasTexture|__texture2d__.Texture2D|__compressedtexture2d__.CompressedTexture2D|__curvetexture__.CurveTexture|__imagetexture__.ImageTexture|__texture2drd__.Texture2DRD|__animatedtexture__.AnimatedTexture|__viewporttexture__.ViewportTexture|__meshtexture__.MeshTexture|__atlastexture__.AtlasTexture|__cameratexture__.CameraTexture|__curvexyztexture__.CurveXYZTexture|__gradienttexture1d__.GradientTexture1D|__placeholdertexture2d__.PlaceholderTexture2D|__gradienttexture2d__.GradientTexture2D|__noisetexture2d__.NoiseTexture2D|__externaltexture__.ExternalTexture: pass

  def capture_rect(self)->__core__.Rect2: pass

  def restart(self, keep_seed:bool=False)->None: pass

  def set_sub_emitter(self, path:__core__.NodePath|str)->None: pass

  def get_sub_emitter(self)->__core__.NodePath: pass

  def emit_particle(self, xform:__core__.Transform2D, velocity:__core__.Vector2, color:__core__.Color, custom:__core__.Color, flags:int)->None: pass
  ...
  def set_trail_sections(self, sections:int)->None: pass

  def get_trail_sections(self)->int: pass

  def set_trail_section_subdivisions(self, subdivisions:int)->None: pass

  def get_trail_section_subdivisions(self)->int: pass
  ...
  def set_use_fixed_seed(self, use_fixed_seed:bool)->None: pass

  def get_use_fixed_seed(self)->bool: pass
