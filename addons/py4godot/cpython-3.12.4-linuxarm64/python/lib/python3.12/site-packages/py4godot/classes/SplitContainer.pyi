...
class SplitContainer(__container__.Container):
  ...
  @property
  def dragging_enabled(self)->bool: pass
  @dragging_enabled.setter
  def dragging_enabled(self,  value:bool)->None: pass
  @property
  ...
  @property
  def drag_area_margin_begin(self)->int: pass
  @drag_area_margin_begin.setter
  def drag_area_margin_begin(self,  value:int)->None: pass
  @property
  def drag_area_margin_end(self)->int: pass
  @drag_area_margin_end.setter
  def drag_area_margin_end(self,  value:int)->None: pass
  @property
  def drag_area_offset(self)->int: pass
  @drag_area_offset.setter
  def drag_area_offset(self,  value:int)->None: pass
  @property
  def drag_area_highlight_in_editor(self)->bool: pass
  @drag_area_highlight_in_editor.setter
  def drag_area_highlight_in_editor(self,  value:bool)->None: pass
