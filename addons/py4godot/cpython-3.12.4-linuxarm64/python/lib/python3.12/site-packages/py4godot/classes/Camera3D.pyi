...
class Camera3D(__node3d__.Node3D):
  ...
  @attributes.setter
  def attributes(self,  value:__cameraattributespractical__.CameraAttributesPractical)->None: pass
  @property
  ...
  def get_attributes(self)->__cameraattributespractical__.CameraAttributesPractical|__cameraattributesphysical__.CameraAttributesPhysical|__cameraattributes__.CameraAttributes: pass
  ...
  def get_frustum(self)->typedarray::Plane: pass
