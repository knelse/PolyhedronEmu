...
class PhysicsTestMotionParameters2D(__refcounted__.RefCounted):
  ...
  @property
  def from_(self)->__core__.Transform2D: pass
  @from_.setter
  def from_(self,  value:__core__.Transform2D)->None: pass
  @property
  ...
  def get_from(self)->__core__.Transform2D: pass

  def set_from(self, from_:__core__.Transform2D)->None: pass
  ...
  def get_exclude_bodies(self)->typedarray::RID: pass

  def set_exclude_bodies(self, exclude_list:__core__.Array)->None: pass

  def get_exclude_objects(self)->typedarray::int: pass
