...
class AnimationPlayer(__animationmixer__.AnimationMixer):
  ...
  def animation_set_next(self, animation_from:__core__.StringName|str, animation_to:__core__.StringName|str)->None: pass

  def animation_get_next(self, animation_from:__core__.StringName|str)->__core__.StringName: pass

  def set_blend_time(self, animation_from:__core__.StringName|str, animation_to:__core__.StringName|str, sec:float)->None: pass

  def get_blend_time(self, animation_from:__core__.StringName|str, animation_to:__core__.StringName|str)->float: pass
  ...
  def play(self, name:__core__.StringName|str= __core__.StringName.new0(), custom_blend:float=-1, custom_speed:float=1.0, from_end:bool=False)->None: pass

  def play_section_with_markers(self, name:__core__.StringName|str= __core__.StringName.new0(), start_marker:__core__.StringName|str= __core__.StringName.new0(), end_marker:__core__.StringName|str= __core__.StringName.new0(), custom_blend:float=-1, custom_speed:float=1.0, from_end:bool=False)->None: pass

  def play_section(self, name:__core__.StringName|str= __core__.StringName.new0(), start_time:float=-1, end_time:float=-1, custom_blend:float=-1, custom_speed:float=1.0, from_end:bool=False)->None: pass

  def play_backwards(self, name:__core__.StringName|str= __core__.StringName.new0(), custom_blend:float=-1)->None: pass

  def play_section_with_markers_backwards(self, name:__core__.StringName|str= __core__.StringName.new0(), start_marker:__core__.StringName|str= __core__.StringName.new0(), end_marker:__core__.StringName|str= __core__.StringName.new0(), custom_blend:float=-1)->None: pass

  def play_section_backwards(self, name:__core__.StringName|str= __core__.StringName.new0(), start_time:float=-1, end_time:float=-1, custom_blend:float=-1)->None: pass

  def play_with_capture(self, name:__core__.StringName|str= __core__.StringName.new0(), duration:float=-1.0, custom_blend:float=-1, custom_speed:float=1.0, from_end:bool=False, trans_type:int =0, ease_type:int =0)->None: pass
  ...
  def queue(self, name:__core__.StringName|str)->None: pass
  ...
  def set_section_with_markers(self, start_marker:__core__.StringName|str= __core__.StringName.new0(), end_marker:__core__.StringName|str= __core__.StringName.new0())->None: pass

  def set_section(self, start_time:float=-1, end_time:float=-1)->None: pass

  def reset_section(self)->None: pass

  def get_section_start_time(self)->float: pass

  def get_section_end_time(self)->float: pass

  def has_section(self)->bool: pass
  ...
  def set_root(self, path:__core__.NodePath|str)->None: pass
