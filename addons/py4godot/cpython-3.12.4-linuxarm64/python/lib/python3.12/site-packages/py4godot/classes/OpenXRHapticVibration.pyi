...
class OpenXRHapticVibration(__openxrhapticbase__.OpenXRHapticBase):
  ...
  @duration.setter
  def duration(self,  value:int)->None: pass
  @property
  def frequency(self)->float: pass
  @frequency.setter
  def frequency(self,  value:float)->None: pass
  @property
  def amplitude(self)->float: pass
  @amplitude.setter
  def amplitude(self,  value:float)->None: pass
  def set_duration(self, duration:int)->None: pass
  ...
  def set_amplitude(self, amplitude:float)->None: pass

  def get_amplitude(self)->float: pass
