...
class AnimationNodeStateMachine(__animationrootnode__.AnimationRootNode):
  ...
  def replace_node(self, name:__core__.StringName|str, node:__animationnode__.AnimationNode)->None: pass

  def get_node(self, name:__core__.StringName|str)->__animationnodeblendtree__.AnimationNodeBlendTree|__animationnodestatemachine__.AnimationNodeStateMachine|__animationnodeextension__.AnimationNodeExtension|__animationrootnode__.AnimationRootNode|__animationnodeblendspace1d__.AnimationNodeBlendSpace1D|__animationnodeadd3__.AnimationNodeAdd3|__animationnodesub2__.AnimationNodeSub2|__animationnodeoutput__.AnimationNodeOutput|__animationnodeadd2__.AnimationNodeAdd2|__animationnodetimeseek__.AnimationNodeTimeSeek|__animationnodesync__.AnimationNodeSync|__animationnodetimescale__.AnimationNodeTimeScale|__animationnodeoneshot__.AnimationNodeOneShot|__animationnodeanimation__.AnimationNodeAnimation|__animationnode__.AnimationNode|__animationnodetransition__.AnimationNodeTransition|__animationnodeblendspace2d__.AnimationNodeBlendSpace2D|__animationnodeblend3__.AnimationNodeBlend3|__animationnodeblend2__.AnimationNodeBlend2: pass
  ...
  def has_transition(self, from_:__core__.StringName|str, to:__core__.StringName|str)->bool: pass

  def add_transition(self, from_:__core__.StringName|str, to:__core__.StringName|str, transition:__animationnodestatemachinetransition__.AnimationNodeStateMachineTransition)->None: pass
  ...
  def remove_transition(self, from_:__core__.StringName|str, to:__core__.StringName|str)->None: pass
