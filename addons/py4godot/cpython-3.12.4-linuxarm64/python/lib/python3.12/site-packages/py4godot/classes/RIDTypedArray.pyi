...
class RIDTypedArray():
  ...
  @staticmethod
  def new0() -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new1(from_:Array) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new2(base:Array, type:int, class_name:__core__.StringName|str, script:object) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new3(from_:PackedByteArray) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new4(from_:PackedInt32Array) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new5(from_:PackedInt64Array) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new6(from_:PackedFloat32Array) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new7(from_:PackedFloat64Array) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new8(from_:PackedStringArray) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new9(from_:PackedVector2Array) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new10(from_:PackedVector3Array) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new11(from_:PackedColorArray) -> __ridtypedarray__.RIDTypedArray:pass
  @staticmethod
  def new12(from_:PackedVector4Array) -> __ridtypedarray__.RIDTypedArray:pass
