...
class RenderData(__object__.Object):
  ...
  def get_render_scene_buffers(self)->__renderscenebuffers__.RenderSceneBuffers|__renderscenebuffersrd__.RenderSceneBuffersRD|__renderscenebuffersextension__.RenderSceneBuffersExtension: pass

  def get_render_scene_data(self)->__renderscenedataextension__.RenderSceneDataExtension|__renderscenedata__.RenderSceneData|__renderscenedatard__.RenderSceneDataRD: pass

  def get_environment(self)->__core__.RID: pass

  def get_camera_attributes(self)->__core__.RID: pass
