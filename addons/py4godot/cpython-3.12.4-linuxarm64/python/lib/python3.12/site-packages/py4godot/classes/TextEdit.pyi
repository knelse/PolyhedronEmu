...
class TextEdit(__control__.Control):
  ...
  @property
  def empty_selection_clipboard_enabled(self)->bool: pass
  @empty_selection_clipboard_enabled.setter
  def empty_selection_clipboard_enabled(self,  value:bool)->None: pass
  @property
  ...
  @property
  def scroll_fit_content_width(self)->bool: pass
  @scroll_fit_content_width.setter
  def scroll_fit_content_width(self,  value:bool)->None: pass
  @property
  ...
  @property
  def syntax_highlighter(self)->__editorsyntaxhighlighter__.EditorSyntaxHighlighter|__syntaxhighlighter__.SyntaxHighlighter|__codehighlighter__.CodeHighlighter|__gdscriptsyntaxhighlighter__.GDScriptSyntaxHighlighter: pass
  ...
  def set_empty_selection_clipboard_enabled(self, enabled:bool)->None: pass

  def is_empty_selection_clipboard_enabled(self)->bool: pass
  ...
  def get_line_with_ime(self, line:int)->str: pass
  ...
  def get_line_column_at_pos(self, position:__core__.Vector2i, clamp_line:bool=True, clamp_column:bool=True)->__core__.Vector2i: pass
  ...
  def get_line_ranges_from_carets(self, only_selections:bool=False, merge_adjacent:bool=True)->typedarray::Vector2i: pass
  ...
  def set_fit_content_width_enabled(self, enabled:bool)->None: pass

  def is_fit_content_width_enabled(self)->bool: pass
  ...
  def get_syntax_highlighter(self)->__editorsyntaxhighlighter__.EditorSyntaxHighlighter|__syntaxhighlighter__.SyntaxHighlighter|__codehighlighter__.CodeHighlighter|__gdscriptsyntaxhighlighter__.GDScriptSyntaxHighlighter: pass
