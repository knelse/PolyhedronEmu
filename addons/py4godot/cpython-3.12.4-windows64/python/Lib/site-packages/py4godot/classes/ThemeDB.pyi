...
class ThemeDB(__object__.Object):
  ...
  @property
  def fallback_font(self)->__fontfile__.FontFile|__font__.Font|__fontvariation__.FontVariation|__systemfont__.SystemFont: pass
  ...
  def get_fallback_font(self)->__fontfile__.FontFile|__font__.Font|__fontvariation__.FontVariation|__systemfont__.SystemFont: pass
  ...
  def get_fallback_icon(self)->__noisetexture2d__.NoiseTexture2D|__texture2d__.Texture2D|__gradienttexture2d__.GradientTexture2D|__imagetexture__.ImageTexture|__atlastexture__.AtlasTexture|__animatedtexture__.AnimatedTexture|__canvastexture__.CanvasTexture|__portablecompressedtexture2d__.PortableCompressedTexture2D|__cameratexture__.CameraTexture|__externaltexture__.ExternalTexture|__placeholdertexture2d__.PlaceholderTexture2D|__compressedtexture2d__.CompressedTexture2D|__curvexyztexture__.CurveXYZTexture|__meshtexture__.MeshTexture|__viewporttexture__.ViewportTexture|__curvetexture__.CurveTexture|__gradienttexture1d__.GradientTexture1D|__texture2drd__.Texture2DRD: pass

  def set_fallback_stylebox(self, stylebox:__stylebox__.StyleBox)->None: pass

  def get_fallback_stylebox(self)->__styleboxline__.StyleBoxLine|__styleboxflat__.StyleBoxFlat|__stylebox__.StyleBox|__styleboxtexture__.StyleBoxTexture|__styleboxempty__.StyleBoxEmpty: pass
