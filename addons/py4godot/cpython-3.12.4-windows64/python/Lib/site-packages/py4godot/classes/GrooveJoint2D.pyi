...
class GrooveJoint2D(__joint2d__.Joint2D):
  ...
  @property
  def initial_offset(self)->float: pass
  @initial_offset.setter
  def initial_offset(self,  value:float)->None: pass
  def set_length(self, length:float)->None: pass

  def get_length(self)->float: pass

  def set_initial_offset(self, offset:float)->None: pass

  def get_initial_offset(self)->float: pass
