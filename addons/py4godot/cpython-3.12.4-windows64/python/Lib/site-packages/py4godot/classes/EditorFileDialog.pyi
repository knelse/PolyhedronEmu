...
class EditorFileDialog(__confirmationdialog__.ConfirmationDialog):
  ...
  def get_vbox(self)->__colorpicker__.ColorPicker|__vboxcontainer__.VBoxContainer|__scripteditorbase__.ScriptEditorBase|__filesystemdock__.FileSystemDock: pass
