...
class RegEx(__refcounted__.RefCounted):
  ...
  @staticmethod
  def create_from_string(pattern:str, show_error:bool=True)->__regex__.RegEx: pass

  def clear(self)->None: pass

  def compile(self, pattern:str, show_error:bool=True)->int: pass

  def search(self, subject:str, offset:int=0, end:int=-1)->__regexmatch__.RegExMatch: pass

  def search_all(self, subject:str, offset:int=0, end:int=-1)->typedarray::RegExMatch: pass
