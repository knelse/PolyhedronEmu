...
class TextServerManager(__object__.Object):
  ...
  def get_interface(self, idx:int)->__textserverextension__.TextServerExtension|__textserveradvanced__.TextServerAdvanced|__textserver__.TextServer|__textserverdummy__.TextServerDummy: pass

  def get_interfaces(self)->typedarray::Dictionary: pass

  def find_interface(self, name:str)->__textserverextension__.TextServerExtension|__textserveradvanced__.TextServerAdvanced|__textserver__.TextServer|__textserverdummy__.TextServerDummy: pass

  def set_primary_interface(self, index:__textserver__.TextServer)->None: pass

  def get_primary_interface(self)->__textserverextension__.TextServerExtension|__textserveradvanced__.TextServerAdvanced|__textserver__.TextServer|__textserverdummy__.TextServerDummy: pass
