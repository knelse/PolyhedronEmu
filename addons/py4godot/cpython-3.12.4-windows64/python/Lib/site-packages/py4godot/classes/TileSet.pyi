...
class TileSet(__resource__.Resource):
  ...
  def get_source(self, source_id:int)->__tilesetscenescollectionsource__.TileSetScenesCollectionSource|__tilesetsource__.TileSetSource|__tilesetatlassource__.TileSetAtlasSource: pass
