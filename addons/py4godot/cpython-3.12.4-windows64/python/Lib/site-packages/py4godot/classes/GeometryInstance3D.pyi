...
class GeometryInstance3D(__visualinstance3d__.VisualInstance3D):
  ...
  def material_override(self,  value:__basematerial3d__.BaseMaterial3D)->None: pass
  @property
  def material_overlay(self)->BaseMaterial3D,ShaderMaterial: pass
  @material_overlay.setter
  def material_overlay(self,  value:__basematerial3d__.BaseMaterial3D)->None: pass
  @property
  ...
  @property
  def gi_lightmap_texel_scale(self)->float: pass
  @gi_lightmap_texel_scale.setter
  def gi_lightmap_texel_scale(self,  value:float)->None: pass
  @property
  ...
  def get_material_override(self)->__canvasitemmaterial__.CanvasItemMaterial|__particleprocessmaterial__.ParticleProcessMaterial|__material__.Material|__physicalskymaterial__.PhysicalSkyMaterial|__shadermaterial__.ShaderMaterial|__proceduralskymaterial__.ProceduralSkyMaterial|__basematerial3d__.BaseMaterial3D|__ormmaterial3d__.ORMMaterial3D|__fogmaterial__.FogMaterial|__standardmaterial3d__.StandardMaterial3D|__placeholdermaterial__.PlaceholderMaterial|__panoramaskymaterial__.PanoramaSkyMaterial: pass

  def set_material_overlay(self, material:__material__.Material)->None: pass

  def get_material_overlay(self)->__canvasitemmaterial__.CanvasItemMaterial|__particleprocessmaterial__.ParticleProcessMaterial|__material__.Material|__physicalskymaterial__.PhysicalSkyMaterial|__shadermaterial__.ShaderMaterial|__proceduralskymaterial__.ProceduralSkyMaterial|__basematerial3d__.BaseMaterial3D|__ormmaterial3d__.ORMMaterial3D|__fogmaterial__.FogMaterial|__standardmaterial3d__.StandardMaterial3D|__placeholdermaterial__.PlaceholderMaterial|__panoramaskymaterial__.PanoramaSkyMaterial: pass
  ...
  def set_lightmap_texel_scale(self, scale:float)->None: pass

  def get_lightmap_texel_scale(self)->float: pass
