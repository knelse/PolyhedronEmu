...
class Mesh(__resource__.Resource):
  ...
  def _surface_get_blend_shape_arrays(self, index:int)->typedarray::Array: pass
  ...
  def _surface_get_material(self, index:int)->__canvasitemmaterial__.CanvasItemMaterial|__particleprocessmaterial__.ParticleProcessMaterial|__material__.Material|__physicalskymaterial__.PhysicalSkyMaterial|__shadermaterial__.ShaderMaterial|__proceduralskymaterial__.ProceduralSkyMaterial|__basematerial3d__.BaseMaterial3D|__ormmaterial3d__.ORMMaterial3D|__fogmaterial__.FogMaterial|__standardmaterial3d__.StandardMaterial3D|__placeholdermaterial__.PlaceholderMaterial|__panoramaskymaterial__.PanoramaSkyMaterial: pass

  def _get_blend_shape_count(self)->int: pass

  def _get_blend_shape_name(self, index:int)->__core__.StringName: pass

  def _set_blend_shape_name(self, index:int, name:__core__.StringName|str)->None: pass
  ...
  def create_outline(self, margin:float)->__ribbontrailmesh__.RibbonTrailMesh|__torusmesh__.TorusMesh|__boxmesh__.BoxMesh|__placeholdermesh__.PlaceholderMesh|__arraymesh__.ArrayMesh|__pointmesh__.PointMesh|__primitivemesh__.PrimitiveMesh|__cylindermesh__.CylinderMesh|__prismmesh__.PrismMesh|__mesh__.Mesh|__quadmesh__.QuadMesh|__immediatemesh__.ImmediateMesh|__planemesh__.PlaneMesh|__spheremesh__.SphereMesh|__capsulemesh__.CapsuleMesh|__textmesh__.TextMesh|__tubetrailmesh__.TubeTrailMesh: pass
