...
class ImageTypedArray():
  ...
  @staticmethod
  def new0() -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new1(from_:Array) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new2(base:Array, type:int, class_name:__core__.StringName|str, script:object) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new3(from_:PackedByteArray) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new4(from_:PackedInt32Array) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new5(from_:PackedInt64Array) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new6(from_:PackedFloat32Array) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new7(from_:PackedFloat64Array) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new8(from_:PackedStringArray) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new9(from_:PackedVector2Array) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new10(from_:PackedVector3Array) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new11(from_:PackedColorArray) -> __imagetypedarray__.ImageTypedArray:pass
  @staticmethod
  def new12(from_:PackedVector4Array) -> __imagetypedarray__.ImageTypedArray:pass
