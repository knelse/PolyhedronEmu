...
class CSGPolygon3D(__csgprimitive3d__.CSGPrimitive3D):
  ...
  @property
  def path_rotation_accurate(self)->bool: pass
  @path_rotation_accurate.setter
  def path_rotation_accurate(self,  value:bool)->None: pass
  @property
  ...
  def set_path_node(self, path:__core__.NodePath|str)->None: pass
  ...
  def set_path_rotation_accurate(self, enable:bool)->None: pass

  def get_path_rotation_accurate(self)->bool: pass
