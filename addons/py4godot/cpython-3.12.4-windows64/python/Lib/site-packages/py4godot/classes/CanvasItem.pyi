...
class CanvasItem(__node__.Node):
  ...
  def get_material(self)->__canvasitemmaterial__.CanvasItemMaterial|__particleprocessmaterial__.ParticleProcessMaterial|__material__.Material|__physicalskymaterial__.PhysicalSkyMaterial|__shadermaterial__.ShaderMaterial|__proceduralskymaterial__.ProceduralSkyMaterial|__basematerial3d__.BaseMaterial3D|__ormmaterial3d__.ORMMaterial3D|__fogmaterial__.FogMaterial|__standardmaterial3d__.StandardMaterial3D|__placeholdermaterial__.PlaceholderMaterial|__panoramaskymaterial__.PanoramaSkyMaterial: pass
  ...
  def make_input_local(self, event:__inputevent__.InputEvent)->__inputeventpangesture__.InputEventPanGesture|__inputeventjoypadmotion__.InputEventJoypadMotion|__inputeventscreentouch__.InputEventScreenTouch|__inputeventmousebutton__.InputEventMouseButton|__inputeventshortcut__.InputEventShortcut|__inputeventfromwindow__.InputEventFromWindow|__inputeventscreendrag__.InputEventScreenDrag|__inputeventkey__.InputEventKey|__inputevent__.InputEvent|__inputeventjoypadbutton__.InputEventJoypadButton|__inputeventmidi__.InputEventMIDI|__inputeventmouse__.InputEventMouse|__inputeventaction__.InputEventAction|__inputeventwithmodifiers__.InputEventWithModifiers|__inputeventgesture__.InputEventGesture|__inputeventmousemotion__.InputEventMouseMotion|__inputeventmagnifygesture__.InputEventMagnifyGesture: pass
