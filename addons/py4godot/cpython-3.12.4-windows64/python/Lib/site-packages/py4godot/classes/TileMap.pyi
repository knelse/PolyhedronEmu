...
class TileMap(__node2d__.Node2D):
  ...
  def is_cell_flipped_h(self, layer:int, coords:__core__.Vector2i, use_proxies:bool=False)->bool: pass

  def is_cell_flipped_v(self, layer:int, coords:__core__.Vector2i, use_proxies:bool=False)->bool: pass

  def is_cell_transposed(self, layer:int, coords:__core__.Vector2i, use_proxies:bool=False)->bool: pass
  ...
  def get_used_cells(self, layer:int)->typedarray::Vector2i: pass

  def get_used_cells_by_id(self, layer:int, source_id:int=-1, atlas_coords:__core__.Vector2i= __core__.Vector2i.new0(), alternative_tile:int=-1)->typedarray::Vector2i: pass
