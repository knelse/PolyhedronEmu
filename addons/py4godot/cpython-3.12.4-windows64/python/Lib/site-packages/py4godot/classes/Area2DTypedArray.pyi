...
class Area2DTypedArray():
  ...
  @staticmethod
  def new0() -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new1(from_:Array) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new2(base:Array, type:int, class_name:__core__.StringName|str, script:object) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new3(from_:PackedByteArray) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new4(from_:PackedInt32Array) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new5(from_:PackedInt64Array) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new6(from_:PackedFloat32Array) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new7(from_:PackedFloat64Array) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new8(from_:PackedStringArray) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new9(from_:PackedVector2Array) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new10(from_:PackedVector3Array) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new11(from_:PackedColorArray) -> __area2dtypedarray__.Area2DTypedArray:pass
  @staticmethod
  def new12(from_:PackedVector4Array) -> __area2dtypedarray__.Area2DTypedArray:pass
