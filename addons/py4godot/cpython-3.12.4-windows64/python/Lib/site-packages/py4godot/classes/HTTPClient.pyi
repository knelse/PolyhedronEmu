...
class HTTPClient(__refcounted__.RefCounted):
  ...
  @property
  def connection(self)->__streampeerbuffer__.StreamPeerBuffer|__streampeertls__.StreamPeerTLS|__streampeertcp__.StreamPeerTCP|__streampeer__.StreamPeer|__streampeerextension__.StreamPeerExtension|__streampeergzip__.StreamPeerGZIP: pass
  @connection.setter
  ...
  def get_connection(self)->__streampeerbuffer__.StreamPeerBuffer|__streampeertls__.StreamPeerTLS|__streampeertcp__.StreamPeerTCP|__streampeer__.StreamPeer|__streampeerextension__.StreamPeerExtension|__streampeergzip__.StreamPeerGZIP: pass
