...
class WebSocketPeer(__packetpeer__.PacketPeer):
  ...
  @property
  def heartbeat_interval(self)->int: pass
  @heartbeat_interval.setter
  def heartbeat_interval(self,  value:int)->None: pass
  ...
  def set_heartbeat_interval(self, interval:float)->None: pass

  def get_heartbeat_interval(self)->float: pass
