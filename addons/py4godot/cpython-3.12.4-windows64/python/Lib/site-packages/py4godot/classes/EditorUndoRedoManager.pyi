...
class EditorUndoRedoManager(__object__.Object):
  ...
  def add_do_method(self, object:__object__.Object, method:__core__.StringName|str)->None: pass

  def add_undo_method(self, object:__object__.Object, method:__core__.StringName|str)->None: pass

  def add_do_property(self, object:__object__.Object, property:__core__.StringName|str, value:object)->None: pass

  def add_undo_property(self, object:__object__.Object, property:__core__.StringName|str, value:object)->None: pass
  ...
  def clear_history(self, id:int=-99, increase_version:bool=True)->None: pass
