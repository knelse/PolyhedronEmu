...
class TileData(__object__.Object):
  ...
  def set_occluder_polygons_count(self, layer_id:int, polygons_count:int)->None: pass

  def get_occluder_polygons_count(self, layer_id:int)->int: pass

  def add_occluder_polygon(self, layer_id:int)->None: pass

  def remove_occluder_polygon(self, layer_id:int, polygon_index:int)->None: pass

  def set_occluder_polygon(self, layer_id:int, polygon_index:int, polygon:__occluderpolygon2d__.OccluderPolygon2D)->None: pass

  def get_occluder_polygon(self, layer_id:int, polygon_index:int, flip_h:bool=False, flip_v:bool=False, transpose:bool=False)->__occluderpolygon2d__.OccluderPolygon2D: pass
  ...
  def has_custom_data(self, layer_name:str)->bool: pass
