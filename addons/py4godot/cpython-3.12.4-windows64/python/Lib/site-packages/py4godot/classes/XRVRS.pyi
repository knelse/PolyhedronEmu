...
class XRVRS(__object__.Object):
  ...
  @property
  def vrs_render_region(self)->__core__.Rect2i: pass
  @vrs_render_region.setter
  def vrs_render_region(self,  value:__core__.Rect2i)->None: pass
  ...
  def get_vrs_render_region(self)->__core__.Rect2i: pass

  def set_vrs_render_region(self, render_region:__core__.Rect2i)->None: pass

  def make_vrs_texture(self, target_size:__core__.Vector2, eye_foci:__core__.PackedVector2Array)->__core__.RID: pass
