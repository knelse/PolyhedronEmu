...
class LightmapGI(__visualinstance3d__.VisualInstance3D):
  ...
  @property
  def supersampling(self)->bool: pass
  @supersampling.setter
  def supersampling(self,  value:bool)->None: pass
  @property
  def supersampling_factor(self)->float: pass
  @supersampling_factor.setter
  def supersampling_factor(self,  value:float)->None: pass
  @property
  ...
  @property
  def shadowmask_mode(self)->int: pass
  @shadowmask_mode.setter
  def shadowmask_mode(self,  value:int)->None: pass
  @property
  ...
  def set_supersampling_enabled(self, enable:bool)->None: pass

  def is_supersampling_enabled(self)->bool: pass

  def set_supersampling_factor(self, factor:float)->None: pass

  def get_supersampling_factor(self)->float: pass
  ...
  def set_shadowmask_mode(self, mode:int )->None: pass

  def get_shadowmask_mode(self)->int: pass
  ...
  def get_camera_attributes(self)->__cameraattributesphysical__.CameraAttributesPhysical|__cameraattributespractical__.CameraAttributesPractical|__cameraattributes__.CameraAttributes: pass
