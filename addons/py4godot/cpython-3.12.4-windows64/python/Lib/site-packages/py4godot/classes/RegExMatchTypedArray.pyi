...
class RegExMatchTypedArray():
  ...
  @staticmethod
  def new0() -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new1(from_:Array) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new2(base:Array, type:int, class_name:__core__.StringName|str, script:object) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new3(from_:PackedByteArray) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new4(from_:PackedInt32Array) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new5(from_:PackedInt64Array) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new6(from_:PackedFloat32Array) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new7(from_:PackedFloat64Array) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new8(from_:PackedStringArray) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new9(from_:PackedVector2Array) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new10(from_:PackedVector3Array) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new11(from_:PackedColorArray) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
  @staticmethod
  def new12(from_:PackedVector4Array) -> __regexmatchtypedarray__.RegExMatchTypedArray:pass
