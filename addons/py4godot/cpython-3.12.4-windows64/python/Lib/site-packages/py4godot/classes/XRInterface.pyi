...
class XRInterface(__refcounted__.RefCounted):
  ...
  def trigger_haptic_pulse(self, action_name:str, tracker_name:__core__.StringName|str, frequency:float, amplitude:float, duration_sec:float, delay_sec:float)->None: pass
