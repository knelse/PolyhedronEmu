...
class WebRTCPeerConnection(__refcounted__.RefCounted):
  ...
  def create_data_channel(self, label:str, options:__core__.Dictionary= __core__.Dictionary.new0())->__webrtcdatachannelextension__.WebRTCDataChannelExtension|__webrtcdatachannel__.WebRTCDataChannel: pass
