...
class EditorSpinSlider(__range__.Range):
  ...
  @property
  def editing_integer(self)->bool: pass
  @editing_integer.setter
  def editing_integer(self,  value:bool)->None: pass
  ...
  def set_editing_integer(self, editing_integer:bool)->None: pass

  def is_editing_integer(self)->bool: pass
