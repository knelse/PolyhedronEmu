...
class Label(__control__.Control):
  ...
  @property
  def paragraph_separator(self)->str: pass
  @paragraph_separator.setter
  def paragraph_separator(self,  value:str)->None: pass
  @property
  ...
  def set_paragraph_separator(self, paragraph_separator:str)->None: pass

  def get_paragraph_separator(self)->str: pass
