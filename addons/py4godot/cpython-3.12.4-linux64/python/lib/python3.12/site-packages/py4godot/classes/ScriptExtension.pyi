...
class ScriptExtension(__script__.Script):
  ...
  def _get_base_script(self)->__scriptextension__.ScriptExtension|__script__.Script|__gdscript__.GDScript: pass
  ...
  def _get_doc_class_name(self)->__core__.StringName: pass

  def _get_documentation(self)->typedarray::Dictionary: pass

  def _get_class_icon_path(self)->str: pass

  def _has_method(self, method:__core__.StringName|str)->bool: pass

  def _has_static_method(self, method:__core__.StringName|str)->bool: pass

  def _get_script_method_argument_count(self, method:__core__.StringName|str)->object: pass

  def _get_method_info(self, method:__core__.StringName|str)->__core__.Dictionary: pass
  ...
  def _get_language(self)->__scriptlanguage__.ScriptLanguage|__scriptlanguageextension__.ScriptLanguageExtension: pass

  def _has_script_signal(self, signal:__core__.StringName|str)->bool: pass

  def _get_script_signal_list(self)->typedarray::Dictionary: pass

  def _has_property_default_value(self, property:__core__.StringName|str)->bool: pass

  def _get_property_default_value(self, property:__core__.StringName|str)->object: pass

  def _update_exports(self)->None: pass

  def _get_script_method_list(self)->typedarray::Dictionary: pass

  def _get_script_property_list(self)->typedarray::Dictionary: pass

  def _get_member_line(self, member:__core__.StringName|str)->int: pass

  def _get_constants(self)->__core__.Dictionary: pass

  def _get_members(self)->typedarray::StringName: pass
