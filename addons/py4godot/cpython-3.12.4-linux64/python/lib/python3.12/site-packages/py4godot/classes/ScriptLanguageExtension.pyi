...
class ScriptLanguageExtension(__scriptlanguage__.ScriptLanguage):
  ...
  def _make_template(self, template:str, class_name:str, base_class_name:str)->__scriptextension__.ScriptExtension|__script__.Script|__gdscript__.GDScript: pass
