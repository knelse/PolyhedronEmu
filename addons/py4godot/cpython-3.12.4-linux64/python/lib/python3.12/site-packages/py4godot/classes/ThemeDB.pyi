...
class ThemeDB(__object__.Object):
  ...
  @property
  def fallback_font(self)->__systemfont__.SystemFont|__font__.Font|__fontfile__.FontFile|__fontvariation__.FontVariation: pass
  ...
  def get_fallback_font(self)->__systemfont__.SystemFont|__font__.Font|__fontfile__.FontFile|__fontvariation__.FontVariation: pass
  ...
  def get_fallback_icon(self)->__curvexyztexture__.CurveXYZTexture|__gradienttexture1d__.GradientTexture1D|__canvastexture__.CanvasTexture|__atlastexture__.AtlasTexture|__texture2d__.Texture2D|__imagetexture__.ImageTexture|__noisetexture2d__.NoiseTexture2D|__viewporttexture__.ViewportTexture|__portablecompressedtexture2d__.PortableCompressedTexture2D|__compressedtexture2d__.CompressedTexture2D|__texture2drd__.Texture2DRD|__curvetexture__.CurveTexture|__animatedtexture__.AnimatedTexture|__cameratexture__.CameraTexture|__meshtexture__.MeshTexture|__gradienttexture2d__.GradientTexture2D|__externaltexture__.ExternalTexture|__placeholdertexture2d__.PlaceholderTexture2D: pass

  def set_fallback_stylebox(self, stylebox:__stylebox__.StyleBox)->None: pass

  def get_fallback_stylebox(self)->__styleboxempty__.StyleBoxEmpty|__styleboxline__.StyleBoxLine|__styleboxtexture__.StyleBoxTexture|__styleboxflat__.StyleBoxFlat|__stylebox__.StyleBox: pass
