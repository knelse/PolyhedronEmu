...
class VisualShaderNodeCubemap(__visualshadernode__.VisualShaderNode):
  ...
  @property
  def source(self)->int: pass
  @source.setter
  def source(self,  value:int)->None: pass
  @property
  def cube_map(self)->Cubemap,CompressedCubemap,PlaceholderCubemap,TextureCubemapRD: pass
  @cube_map.setter
  def cube_map(self,  value:__cubemap__.Cubemap)->None: pass
  @property
  def texture_type(self)->int: pass
  @texture_type.setter
  def texture_type(self,  value:int)->None: pass
  def set_source(self, value:int )->None: pass

  def get_source(self)->int: pass

  def set_cube_map(self, value:__texturelayered__.TextureLayered)->None: pass

  def get_cube_map(self)->__cubemap__.Cubemap|__cubemaparray__.CubemapArray|__compressedtexture2darray__.CompressedTexture2DArray|__texturecubemaparrayrd__.TextureCubemapArrayRD|__imagetexturelayered__.ImageTextureLayered|__texturelayeredrd__.TextureLayeredRD|__texture2darrayrd__.Texture2DArrayRD|__placeholdertexture2darray__.PlaceholderTexture2DArray|__texture2darray__.Texture2DArray|__texturecubemaprd__.TextureCubemapRD|__compressedcubemaparray__.CompressedCubemapArray|__compressedcubemap__.CompressedCubemap|__compressedtexturelayered__.CompressedTextureLayered|__placeholdertexturelayered__.PlaceholderTextureLayered|__texturelayered__.TextureLayered|__placeholdercubemap__.PlaceholderCubemap|__placeholdercubemaparray__.PlaceholderCubemapArray: pass

  def set_texture_type(self, value:int )->None: pass
