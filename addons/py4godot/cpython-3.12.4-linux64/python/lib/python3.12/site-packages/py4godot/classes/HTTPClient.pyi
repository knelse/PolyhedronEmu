...
class HTTPClient(__refcounted__.RefCounted):
  ...
  @property
  def connection(self)->__streampeertls__.StreamPeerTLS|__streampeertcp__.StreamPeerTCP|__streampeerextension__.StreamPeerExtension|__streampeer__.StreamPeer|__streampeerbuffer__.StreamPeerBuffer|__streampeergzip__.StreamPeerGZIP: pass
  @connection.setter
  ...
  def get_connection(self)->__streampeertls__.StreamPeerTLS|__streampeertcp__.StreamPeerTCP|__streampeerextension__.StreamPeerExtension|__streampeer__.StreamPeer|__streampeerbuffer__.StreamPeerBuffer|__streampeergzip__.StreamPeerGZIP: pass
