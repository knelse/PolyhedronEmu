...
class XRServer(__object__.Object):
  ...
  def get_interface(self, idx:int)->__mobilevrinterface__.MobileVRInterface|__xrinterface__.XRInterface|__webxrinterface__.WebXRInterface|__xrinterfaceextension__.XRInterfaceExtension|__openxrinterface__.OpenXRInterface: pass

  def get_interfaces(self)->typedarray::Dictionary: pass

  def find_interface(self, name:str)->__mobilevrinterface__.MobileVRInterface|__xrinterface__.XRInterface|__webxrinterface__.WebXRInterface|__xrinterfaceextension__.XRInterfaceExtension|__openxrinterface__.OpenXRInterface: pass
  ...
  def get_tracker(self, tracker_name:__core__.StringName|str)->__xrfacetracker__.XRFaceTracker|__xrtracker__.XRTracker|__xrcontrollertracker__.XRControllerTracker|__xrbodytracker__.XRBodyTracker|__xrhandtracker__.XRHandTracker|__xrpositionaltracker__.XRPositionalTracker: pass

  def get_primary_interface(self)->__mobilevrinterface__.MobileVRInterface|__xrinterface__.XRInterface|__webxrinterface__.WebXRInterface|__xrinterfaceextension__.XRInterfaceExtension|__openxrinterface__.OpenXRInterface: pass
