...
class PhysicsDirectSpaceState3D(__object__.Object):
  ...
  def intersect_point(self, parameters:__physicspointqueryparameters3d__.PhysicsPointQueryParameters3D, max_results:int=32)->typedarray::Dictionary: pass

  def intersect_ray(self, parameters:__physicsrayqueryparameters3d__.PhysicsRayQueryParameters3D)->__core__.Dictionary: pass

  def intersect_shape(self, parameters:__physicsshapequeryparameters3d__.PhysicsShapeQueryParameters3D, max_results:int=32)->typedarray::Dictionary: pass
  ...
  def collide_shape(self, parameters:__physicsshapequeryparameters3d__.PhysicsShapeQueryParameters3D, max_results:int=32)->typedarray::Vector3: pass
