...
class NavigationServer2D(__object__.Object):
  ...
  def get_maps(self)->typedarray::RID: pass
  ...
  def map_get_path(self, map:__core__.RID, origin:__core__.Vector2, destination:__core__.Vector2, optimize:bool, navigation_layers:int=1)->__core__.PackedVector2Array: pass

  def map_get_closest_point(self, map:__core__.RID, to_point:__core__.Vector2)->__core__.Vector2: pass

  def map_get_closest_point_owner(self, map:__core__.RID, to_point:__core__.Vector2)->__core__.RID: pass

  def map_get_links(self, map:__core__.RID)->typedarray::RID: pass

  def map_get_regions(self, map:__core__.RID)->typedarray::RID: pass

  def map_get_agents(self, map:__core__.RID)->typedarray::RID: pass

  def map_get_obstacles(self, map:__core__.RID)->typedarray::RID: pass

  def map_force_update(self, map:__core__.RID)->None: pass

  def map_get_iteration_id(self, map:__core__.RID)->int: pass

  def map_set_use_async_iterations(self, map:__core__.RID, enabled:bool)->None: pass

  def map_get_use_async_iterations(self, map:__core__.RID)->bool: pass

  def map_get_random_point(self, map:__core__.RID, navigation_layers:int, uniformly:bool)->__core__.Vector2: pass

  def query_path(self, parameters:__navigationpathqueryparameters2d__.NavigationPathQueryParameters2D, result:__navigationpathqueryresult2d__.NavigationPathQueryResult2D, callback:__core__.Callable= __core__.Callable.new0())->None: pass
  ...
  def region_owns_point(self, region:__core__.RID, point:__core__.Vector2)->bool: pass
  ...
  def region_set_transform(self, region:__core__.RID, transform:__core__.Transform2D)->None: pass

  def region_get_transform(self, region:__core__.RID)->__core__.Transform2D: pass

  def region_set_navigation_polygon(self, region:__core__.RID, navigation_polygon:__navigationpolygon__.NavigationPolygon)->None: pass

  def region_get_connections_count(self, region:__core__.RID)->int: pass

  def region_get_connection_pathway_start(self, region:__core__.RID, connection:int)->__core__.Vector2: pass

  def region_get_connection_pathway_end(self, region:__core__.RID, connection:int)->__core__.Vector2: pass

  def region_get_closest_point(self, region:__core__.RID, to_point:__core__.Vector2)->__core__.Vector2: pass

  def region_get_random_point(self, region:__core__.RID, navigation_layers:int, uniformly:bool)->__core__.Vector2: pass

  def region_get_bounds(self, region:__core__.RID)->__core__.Rect2: pass
  ...
  def link_set_start_position(self, link:__core__.RID, position:__core__.Vector2)->None: pass

  def link_get_start_position(self, link:__core__.RID)->__core__.Vector2: pass

  def link_set_end_position(self, link:__core__.RID, position:__core__.Vector2)->None: pass

  def link_get_end_position(self, link:__core__.RID)->__core__.Vector2: pass
  ...
  def agent_set_velocity_forced(self, agent:__core__.RID, velocity:__core__.Vector2)->None: pass

  def agent_set_velocity(self, agent:__core__.RID, velocity:__core__.Vector2)->None: pass

  def agent_get_velocity(self, agent:__core__.RID)->__core__.Vector2: pass

  def agent_set_position(self, agent:__core__.RID, position:__core__.Vector2)->None: pass

  def agent_get_position(self, agent:__core__.RID)->__core__.Vector2: pass
  ...
  def obstacle_set_velocity(self, obstacle:__core__.RID, velocity:__core__.Vector2)->None: pass

  def obstacle_get_velocity(self, obstacle:__core__.RID)->__core__.Vector2: pass

  def obstacle_set_position(self, obstacle:__core__.RID, position:__core__.Vector2)->None: pass

  def obstacle_get_position(self, obstacle:__core__.RID)->__core__.Vector2: pass

  def obstacle_set_vertices(self, obstacle:__core__.RID, vertices:__core__.PackedVector2Array)->None: pass

  def obstacle_get_vertices(self, obstacle:__core__.RID)->__core__.PackedVector2Array: pass
  ...
  def parse_source_geometry_data(self, navigation_polygon:__navigationpolygon__.NavigationPolygon, source_geometry_data:__navigationmeshsourcegeometrydata2d__.NavigationMeshSourceGeometryData2D, root_node:__node__.Node, callback:__core__.Callable= __core__.Callable.new0())->None: pass

  def bake_from_source_geometry_data(self, navigation_polygon:__navigationpolygon__.NavigationPolygon, source_geometry_data:__navigationmeshsourcegeometrydata2d__.NavigationMeshSourceGeometryData2D, callback:__core__.Callable= __core__.Callable.new0())->None: pass

  def bake_from_source_geometry_data_async(self, navigation_polygon:__navigationpolygon__.NavigationPolygon, source_geometry_data:__navigationmeshsourcegeometrydata2d__.NavigationMeshSourceGeometryData2D, callback:__core__.Callable= __core__.Callable.new0())->None: pass

  def is_baking_navigation_polygon(self, navigation_polygon:__navigationpolygon__.NavigationPolygon)->bool: pass
  ...
  def simplify_path(self, path:__core__.PackedVector2Array, epsilon:float)->__core__.PackedVector2Array: pass
