...
class Curve(__resource__.Resource):
  ...
  @property
  def min_domain(self)->float: pass
  @min_domain.setter
  def min_domain(self,  value:float)->None: pass
  @property
  def max_domain(self)->float: pass
  @max_domain.setter
  def max_domain(self,  value:float)->None: pass
  @property
  ...
  def get_value_range(self)->float: pass

  def get_min_domain(self)->float: pass

  def set_min_domain(self, min:float)->None: pass

  def get_max_domain(self)->float: pass

  def set_max_domain(self, max:float)->None: pass

  def get_domain_range(self)->float: pass
