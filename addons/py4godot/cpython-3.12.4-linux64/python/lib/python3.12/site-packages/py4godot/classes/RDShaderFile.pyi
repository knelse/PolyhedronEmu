...
class RDShaderFile(__resource__.Resource):
  ...
  def set_bytecode(self, bytecode:__rdshaderspirv__.RDShaderSPIRV, version:__core__.StringName|str= __core__.StringName.new0())->None: pass

  def get_spirv(self, version:__core__.StringName|str= __core__.StringName.new0())->__rdshaderspirv__.RDShaderSPIRV: pass

  def get_version_list(self)->typedarray::StringName: pass
