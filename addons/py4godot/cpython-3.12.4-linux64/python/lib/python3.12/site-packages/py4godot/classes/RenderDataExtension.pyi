...
class RenderDataExtension(__renderdata__.RenderData):
  ...
  def _get_render_scene_buffers(self)->__renderscenebuffersrd__.RenderSceneBuffersRD|__renderscenebuffersextension__.RenderSceneBuffersExtension|__renderscenebuffers__.RenderSceneBuffers: pass

  def _get_render_scene_data(self)->__renderscenedatard__.RenderSceneDataRD|__renderscenedataextension__.RenderSceneDataExtension|__renderscenedata__.RenderSceneData: pass

  def _get_environment(self)->__core__.RID: pass

  def _get_camera_attributes(self)->__core__.RID: pass
