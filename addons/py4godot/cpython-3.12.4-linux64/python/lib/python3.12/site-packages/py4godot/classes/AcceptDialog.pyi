...
class AcceptDialog(__window__.Window):
  ...
  def get_ok_button(self)->__checkbutton__.CheckButton|__checkbox__.CheckBox|__button__.Button|__optionbutton__.OptionButton|__colorpickerbutton__.ColorPickerButton|__menubutton__.MenuButton: pass
  ...
  def add_button(self, text:str, right:bool=False, action:str= __core__.String.new0())->__checkbutton__.CheckButton|__checkbox__.CheckBox|__button__.Button|__optionbutton__.OptionButton|__colorpickerbutton__.ColorPickerButton|__menubutton__.MenuButton: pass

  def add_cancel_button(self, name:str)->__checkbutton__.CheckButton|__checkbox__.CheckBox|__button__.Button|__optionbutton__.OptionButton|__colorpickerbutton__.ColorPickerButton|__menubutton__.MenuButton: pass
