...
class GraphEdit(__control__.Control):
  ...
  @property
  def connections(self)->typedarray::27/0:: pass
  @connections.setter
  def connections(self,  value:__core__.Array)->None: pass
  @property
  ...
  def _is_node_hover_valid(self, from_node:__core__.StringName|str, from_port:int, to_node:__core__.StringName|str, to_port:int)->bool: pass

  def connect_node(self, from_node:__core__.StringName|str, from_port:int, to_node:__core__.StringName|str, to_port:int, keep_alive:bool=False)->int: pass

  def is_node_connected(self, from_node:__core__.StringName|str, from_port:int, to_node:__core__.StringName|str, to_port:int)->bool: pass

  def disconnect_node(self, from_node:__core__.StringName|str, from_port:int, to_node:__core__.StringName|str, to_port:int)->None: pass

  def set_connection_activity(self, from_node:__core__.StringName|str, from_port:int, to_node:__core__.StringName|str, to_port:int, amount:float)->None: pass

  def set_connections(self, connections:__core__.Array)->None: pass

  def get_connection_list(self)->typedarray::Dictionary: pass

  def get_connection_count(self, from_node:__core__.StringName|str, from_port:int)->int: pass

  def get_closest_connection_at_point(self, point:__core__.Vector2, max_distance:float=4.0)->__core__.Dictionary: pass

  def get_connections_intersecting_with_rect(self, rect:__core__.Rect2)->typedarray::Dictionary: pass
  ...
  def attach_graph_element_to_frame(self, element:__core__.StringName|str, frame:__core__.StringName|str)->None: pass

  def detach_graph_element_from_frame(self, element:__core__.StringName|str)->None: pass

  def get_element_frame(self, element:__core__.StringName|str)->__graphframe__.GraphFrame: pass

  def get_attached_nodes_of_frame(self, frame:__core__.StringName|str)->typedarray::StringName: pass
  ...
  def get_menu_hbox(self)->__editorresourcepicker__.EditorResourcePicker|__openxrinteractionprofileeditorbase__.OpenXRInteractionProfileEditorBase|__editortoaster__.EditorToaster|__editorscriptpicker__.EditorScriptPicker|__openxrinteractionprofileeditor__.OpenXRInteractionProfileEditor|__hboxcontainer__.HBoxContainer: pass
