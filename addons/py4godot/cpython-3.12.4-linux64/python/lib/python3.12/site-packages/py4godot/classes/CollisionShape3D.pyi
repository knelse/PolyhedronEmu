...
class CollisionShape3D(__node3d__.Node3D):
  ...
  @property
  def debug_fill(self)->bool: pass
  @debug_fill.setter
  def debug_fill(self,  value:bool)->None: pass
  def resource_changed(self, resource:__resource__.Resource)->None: pass

  def set_shape(self, shape:__shape3d__.Shape3D)->None: pass

  def get_shape(self)->__shape3d__.Shape3D|__sphereshape3d__.SphereShape3D|__concavepolygonshape3d__.ConcavePolygonShape3D|__separationrayshape3d__.SeparationRayShape3D|__worldboundaryshape3d__.WorldBoundaryShape3D|__capsuleshape3d__.CapsuleShape3D|__boxshape3d__.BoxShape3D|__convexpolygonshape3d__.ConvexPolygonShape3D|__cylindershape3d__.CylinderShape3D|__heightmapshape3d__.HeightMapShape3D: pass
  ...
  def set_enable_debug_fill(self, enable:bool)->None: pass

  def get_enable_debug_fill(self)->bool: pass
