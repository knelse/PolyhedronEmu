...
class AudioStreamPlayer2D(__node2d__.Node2D):
  ...
  def get_stream(self)->__audiostream__.AudioStream|__audiostreamoggvorbis__.AudioStreamOggVorbis|__audiostreamplaylist__.AudioStreamPlaylist|__audiostreammp3__.AudioStreamMP3|__audiostreaminteractive__.AudioStreamInteractive|__audiostreamrandomizer__.AudioStreamRandomizer|__audiostreammicrophone__.AudioStreamMicrophone|__audiostreamsynchronized__.AudioStreamSynchronized|__audiostreamwav__.AudioStreamWAV|__audiostreampolyphonic__.AudioStreamPolyphonic|__audiostreamgenerator__.AudioStreamGenerator: pass
  ...
  def get_stream_playback(self)->__audiostreamplaybackpolyphonic__.AudioStreamPlaybackPolyphonic|__audiostreamplaybackoggvorbis__.AudioStreamPlaybackOggVorbis|__audiostreamplaybackresampled__.AudioStreamPlaybackResampled|__audiostreamplayback__.AudioStreamPlayback|__audiostreamplaybackplaylist__.AudioStreamPlaybackPlaylist|__audiostreamplaybacksynchronized__.AudioStreamPlaybackSynchronized|__audiostreamgeneratorplayback__.AudioStreamGeneratorPlayback|__audiostreamplaybackinteractive__.AudioStreamPlaybackInteractive: pass
