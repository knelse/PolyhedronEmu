...
class EditorFileDialog(__confirmationdialog__.ConfirmationDialog):
  ...
  def get_vbox(self)->__vboxcontainer__.VBoxContainer|__filesystemdock__.FileSystemDock|__colorpicker__.ColorPicker|__scripteditorbase__.ScriptEditorBase: pass
