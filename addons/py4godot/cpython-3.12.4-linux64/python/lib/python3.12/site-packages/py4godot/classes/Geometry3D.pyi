...
class Geometry3D(__object__.Object):
  ...
  def build_box_planes(self, extents:__core__.Vector3)->typedarray::Plane: pass

  def build_cylinder_planes(self, radius:float, height:float, sides:int, axis:int =2)->typedarray::Plane: pass

  def build_capsule_planes(self, radius:float, height:float, sides:int, lats:int, axis:int =2)->typedarray::Plane: pass
