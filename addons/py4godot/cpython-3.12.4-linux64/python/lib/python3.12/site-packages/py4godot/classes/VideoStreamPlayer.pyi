...
class VideoStreamPlayer(__control__.Control):
  ...
  @property
  def stream(self)->__videostream__.VideoStream|__videostreamtheora__.VideoStreamTheora: pass
  @stream.setter
  ...
  def get_stream(self)->__videostream__.VideoStream|__videostreamtheora__.VideoStreamTheora: pass
