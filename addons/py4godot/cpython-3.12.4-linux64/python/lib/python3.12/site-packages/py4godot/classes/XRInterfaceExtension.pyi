...
class XRInterfaceExtension(__xrinterface__.XRInterface):
  ...
  def _get_suggested_pose_names(self, tracker_name:__core__.StringName|str)->__core__.PackedStringArray: pass

  def _get_tracking_status(self)->int: pass

  def _trigger_haptic_pulse(self, action_name:str, tracker_name:__core__.StringName|str, frequency:float, amplitude:float, duration_sec:float, delay_sec:float)->None: pass
