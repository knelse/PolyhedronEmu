...
class CanvasItem(__node__.Node):
  ...
  def make_input_local(self, event:__inputevent__.InputEvent)->__inputevent__.InputEvent|__inputeventpangesture__.InputEventPanGesture|__inputeventshortcut__.InputEventShortcut|__inputeventscreentouch__.InputEventScreenTouch|__inputeventscreendrag__.InputEventScreenDrag|__inputeventkey__.InputEventKey|__inputeventfromwindow__.InputEventFromWindow|__inputeventmouse__.InputEventMouse|__inputeventmousebutton__.InputEventMouseButton|__inputeventmousemotion__.InputEventMouseMotion|__inputeventmagnifygesture__.InputEventMagnifyGesture|__inputeventgesture__.InputEventGesture|__inputeventmidi__.InputEventMIDI|__inputeventaction__.InputEventAction|__inputeventjoypadbutton__.InputEventJoypadButton|__inputeventjoypadmotion__.InputEventJoypadMotion|__inputeventwithmodifiers__.InputEventWithModifiers: pass
