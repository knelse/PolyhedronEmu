...
class PackedByteArrayTypedArray():
  ...
  @staticmethod
  def new0() -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new1(from_:Array) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new2(base:Array, type:int, class_name:__core__.StringName|str, script:object) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new3(from_:PackedByteArray) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new4(from_:PackedInt32Array) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new5(from_:PackedInt64Array) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new6(from_:PackedFloat32Array) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new7(from_:PackedFloat64Array) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new8(from_:PackedStringArray) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new9(from_:PackedVector2Array) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new10(from_:PackedVector3Array) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new11(from_:PackedColorArray) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
  @staticmethod
  def new12(from_:PackedVector4Array) -> __packedbytearraytypedarray__.PackedByteArrayTypedArray:pass
