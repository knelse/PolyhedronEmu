...
class RDTextureFormat(__refcounted__.RefCounted):
  ...
  @property
  def is_resolve_buffer(self)->bool: pass
  @is_resolve_buffer.setter
  def is_resolve_buffer(self,  value:bool)->None: pass
  @property
  def is_discardable(self)->bool: pass
  @is_discardable.setter
  def is_discardable(self,  value:bool)->None: pass
  ...
  def set_is_resolve_buffer(self, p_member:bool)->None: pass

  def get_is_resolve_buffer(self)->bool: pass

  def set_is_discardable(self, p_member:bool)->None: pass

  def get_is_discardable(self)->bool: pass
