...
class ButtonGroup(__resource__.Resource):
  pressed: BuiltinSignal

  @staticmethod
  def constructor()->ButtonGroup:pass



  @staticmethod
  def cast(other:__object__.Object)->ButtonGroup:pass


  @property
  def allow_unpress(self)->bool: pass
  @allow_unpress.setter
  def allow_unpress(self,  value:bool)->None: pass
  def get_pressed_button(self)->__texturebutton__.TextureButton|__linkbutton__.LinkButton|__button__.Button|__optionbutton__.OptionButton|__colorpickerbutton__.ColorPickerButton|__basebutton__.BaseButton|__checkbutton__.CheckButton|__checkbox__.CheckBox|__menubutton__.MenuButton: pass

  def get_buttons(self)->typedarray::BaseButton: pass

  def set_allow_unpress(self, enabled:bool)->None: pass

  def is_allow_unpress(self)->bool: pass
