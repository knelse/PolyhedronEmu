...
class CellNeighbor:
  ...
  CELL_NEIGHBOR_TOPERATOR_LEFT_SIDE:int = 10
  CELL_NEIGHBOR_TOPERATOR_LEFT_CORNER:int = 11
  CELL_NEIGHBOR_TOPERATOR_SIDE:int = 12
  CELL_NEIGHBOR_TOPERATOR_CORNER:int = 13
  CELL_NEIGHBOR_TOPERATOR_RIGHT_SIDE:int = 14
  CELL_NEIGHBOR_TOPERATOR_RIGHT_CORNER:int = 15
class TerrainMode:
...
class TileSet(__resource__.Resource):
  ...
  def get_source(self, source_id:int)->__tilesetscenescollectionsource__.TileSetScenesCollectionSource|__tilesetatlassource__.TileSetAtlasSource|__tilesetsource__.TileSetSource: pass
  ...
  def set_physics_layer_collision_priority(self, layer_index:int, priority:float)->None: pass

  def get_physics_layer_collision_priority(self, layer_index:int)->float: pass
  ...
  def has_custom_data_layer_by_name(self, layer_name:str)->bool: pass
